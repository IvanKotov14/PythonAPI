...
@allure.epic("Кейс ввода данных владельца авто")
class TestRegisterOwner(BaseCase):
    random_part = datetime.now().strftime("%m%d%Y%H%M%S")
    @allure.description("Регистрация данных владельца авто с авторизованного пользователя и правильными данными")
    def test_log_owner(self):
        ...
        response = MyRequests.post(url, headers=headers, json=valid_owner)
        Asseretions.assert_code_status(response, 201)
        result = self.get_json_value(response, "person")
        return result

    @allure.description("Регистрация авторизованного владельца авто без указания адреса и без указания данных вовсе")
    def test_log_negative_owner(self):
        url = "v1/insured_objects/owners/natural_persons"
        valid_owner = {
            "last_name": "Угрев",
            "first_name": "Игорь",
    ...
    @allure.description("Регистрация владельца авто без авторизациии")
    def test_log_owner_no_token(self):
        url = "v1/insured_objects/owners/natural_persons"
        valid_owner = {
            "last_name": "Угрев",
            "first_name": "Игорь",
    ...
    @allure.description("Регистрация авторизованного владельца авто с произвольными данными и ожидаемым ответом")
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("Голубев", "Игорь", "Игоревич", "1990-01-01", "+7 (911) 169-99-99", "igor@gmail.com",
             ...
             "2017-03-08", "УФМС", "123-456", "123456", "1234",
             "г Санкт-Петербург, г Ломоносов, ул Швейцарская, д 1 к 1, кв 1",
             "г Санкт-Петербург, г Ломоносов, ул Швейцарская, д 1 к 1, кв 1", "0700000440000",
             "7800000000000",
             "7800000600000", "7800000600000", 400),
            ("Голубев", "Игорь", "Игоревич", "1990-01-01", "+7 (911) 169-99-99", "igor@gmail.com",
             "RUSSIAN_INTERNAL_PASSPORT",
            ...
            ("Голубев", "Игорь", "Игоревич", "1990-01-01", "+7 (911) 169-99-99", "igor@gmail.com",
             ...
             "2017-03-08", "УФМС", "123-456", "123456", "1234",
             "г Санкт-Петербург, г Ломоносов, ул Швейцарская, д 1 к 1, кв 1",
             "г Санкт-Петербург, г Ломоносов, ул Швейцарская, д 1 к 1, кв 1", random_part,
             "7800000000000",
             "7800000600000", "7800000600000", 400),
            ("Голубев", "Игорь", "Игоревич", "1990-01-01", "+7 (911) 169-99-99", "igor@gmail.com",
             "RUSSIAN_INTERNAL_PASSPORT",
            ...
            (
                    ...
                    "7800000000000",
                    "7800000600000", "7800000600000", 400),
            ("Голубев", random_part, "Игоревич", "1990-01-01", "+7 (911) 169-99-99",
             "igor@gmail.com",
             "RUSSIAN_INTERNAL_PASSPORT",
             "2017-03-08", "УФМС", "123-456", "123456", "1234",
             "г Санкт-Петербург, г Ломоносов, ул Швейцарская, д 1 к 1, кв 1",
    ...
    def test_invalid_owner(self, last_name, first_name, patronymic, birth_date, phone, email, credential_type,
        ...
        response = MyRequests.post(url, headers=headers, json=ivalid_owner)
